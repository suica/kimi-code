 ...
 * wiring strategy. This helper exists only because the existing
...
import { ICoreProcessService } from './coreProcess';
import { CoreProcessService } from './coreProcessService';

export function registerCoreProcessService(): void {
  registerSingleton(ICoreProcessService, CoreProcessService, InstantiationType.Eager);
}
