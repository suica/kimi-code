/**
 * Approval broker interface + protocol adapter (W8.1 / Chain 5).
 *
 * **Broker interface** (`IApprovalBroker`): Reverse-RPC broker that routes
 * `ApprovalRequest`s coming out of `KimiCore` to a waiter (web client over
